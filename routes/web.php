...
Route::post('/lab-order', 'LabOrderController@store')->name('lab-order.store');
...
// Route for doctors to store lab tests
Route::post('/lab/store', [AdminController::class, 'storeLabOrder'])->name('lab.store');
...
//Patients Reports
Route::get('/patient-reports', [HomeController::class, 'showPatientReports'])->name('patient.reports');
Route::post('/patient-reports', [HomeController::class, 'getPatientReports'])->name('patient.getReports');
Route::get('/print-report/{id}', [HomeController::class, 'printPatientReport'])->name('patient.printReport');


// In routes/web.php
Route::get('/send/{userId}', [NotifyController::class, 'sendNotification']);

//Route::get('/send-notification/{userId}/{type}', [UserController::class, 'sendNotification']);
