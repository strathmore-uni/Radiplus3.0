                ...
                @if(Route::has('login'))
                    @auth
                        @if(Auth::user()->usertype == 4 || Auth::user()->usertype == 1)
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#complain"
                                aria-expanded="false" aria-controls="collapseLayouts">
                ...
                @if(Route::has('login'))
                    @auth
                        @if(Auth::user()->usertype == 1)
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#cat"
                                aria-expanded="false" aria-controls="collapseLayouts">
